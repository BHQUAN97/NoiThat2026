...
function buildCsp(): string {
  const directives = [
    ...
    `img-src 'self' data: blob: https://*.r2.dev https://*.r2.cloudflarestorage.com https://bhquan.site https://bhquan.store https://images.unsplash.com https://picsum.photos https://lh3.googleusercontent.com`,
