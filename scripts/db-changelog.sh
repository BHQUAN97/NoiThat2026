...
#
# QUAN TRONG: day la nguon migration DUY NHAT cua noithat2026 (khong co ORM).
...
DB_NAME="${DB_NAME:-noithat2026}"
DB_USER="${DB_USER:-noithat}"
ENV_FILE="${ENV_FILE:-/opt/noithat2026/.env}"
